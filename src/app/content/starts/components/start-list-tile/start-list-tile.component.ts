...
import {HeatTimesComponent} from '../../../../layout/element/heat-times/heat-times.component';
import {IconPanelComponent} from '../../../../layout/element/icon-panel/icon-panel.component';

@Component({
    selector: 'sr-start-list-tile',
    templateUrl: './start-list-tile.component.html',
    styleUrls: ['./start-list-tile.component.scss'],
    imports: [HeatTimesComponent, IconPanelComponent, RouterLink, MatIcon, TranslateModule, HeatTimesComponent, IconPanelComponent]
})
